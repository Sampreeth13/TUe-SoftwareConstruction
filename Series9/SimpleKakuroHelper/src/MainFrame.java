...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Intersector in = new Intersector(9, true);
        Intersector el = new Intersector(9, false);
        generatedCombinations.clear();
        gen.addListener(in);
        gen.addListener(el);
        gen.addListener(count);
        gen.addListener(new Lister());
        ...
        if (count.getCount() > 0 && jCheckBox4.isSelected()) {
            printedText += "Interseсtion: " + in.getIntersection() + '\n';
        }

        if (jCheckBox3.isSelected()) {
            printedText += "Elimination: " + el.getIntersection() + '\n';
        }
...
//# END TODO
    ...
    private void initComponents() {
        ...
        jCheckBox3.setText("Elimination");

        jCheckBox4.setSelected(true);
        jCheckBox4.setText("Intersection");
