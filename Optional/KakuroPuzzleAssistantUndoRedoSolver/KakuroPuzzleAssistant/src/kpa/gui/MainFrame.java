...
import kpa.command.SelectedCommand;
...
//        updateFrame();
    ...
    private void jPanelPuzzleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelPuzzleMouseClicked
        ...
        if (cell != null & !cell.isBlocked()) {
            ...
            Command cmd = new SelectedCommand(puzzlePanel, cell);
            urStack.did(cmd);
            jTextArea.append("Selected cell " + cell.getLocation().toString()
                    + "\n");
        } else if (this.puzzlePanel.getSelected() != null) {
            Command cmd = new SelectedCommand(puzzlePanel, null);
            urStack.did(cmd);
        }
    ...
    private void jPanelPuzzleKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPanelPuzzleKeyTyped
        ...
        Command cmd = new SetCommand(puzzlePanel, state);
        urStack.did(cmd);
    ...
    private void jMenuItemSolveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemSolveActionPerformed
        jTextArea.append("Solve is not yet implemented.\n");
    ...
    private void updateFrame() {
        ...
        if (puzzle == null || puzzle.getMode() != KPuzzle.Mode.SOLVE) {
            ...
            jMenuItemUndo.setEnabled(urStack.canUndo());
            jMenuItemUndoAll.setEnabled(urStack.canUndo());
            jMenuItemRedo.setEnabled(urStack.canRedo());
            jMenuItemRedoAll.setEnabled(urStack.canRedo());
        }
