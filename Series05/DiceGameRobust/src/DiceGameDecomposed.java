...
<p><font color="red"><b>@throws IllegalArgumentException  if
        precondition violated</b></font></p>
<!--//# END TODO-->
     * @pre  {@code 1 <= n && 0 <= r}
...
<!--//# BEGIN TODO Contract for exceptions-->
<p><font color="red"><b>@throws NullPointerException  if {@code a == null}
        @throws IllegalArgumentException  if {@code a.length == 0 ||
        \forall i; a.has(i); \exists a[i] < 0}</b></font></p>
<!--//# END TODO-->
...
<p><font color="red"><b>@throws NullPointerException  if {@code a == null}
        @throws IllegalArgumentException  if
        {@code \forall i; a.has(i); a[i] != x} </b></font></p>
<!--//# END TODO-->
...
//# BEGIN TODO Robust implementation
        ...
        throw new IllegalArgumentException(
                "DiceGameDecomposed.find(" + x + ", a)" +
                " violates precondition, because doesn't exist a[i] == " + x);
    }
//# END TODO
