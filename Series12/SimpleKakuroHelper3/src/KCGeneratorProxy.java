...
//# BEGIN TODO Implementation of doInBackground()
            gen.setMaxNumber(maxNumber);
            gen.setObserver(observer);
            gen.generate(sum, length);
//# END TODO
            return null;
        }

        public void setupPredicate(boolean predicate) {
            gen.predicate = predicate;
        }
...
//# BEGIN TODO Implementation of done()
        if (resultListener != null) {
                resultListener.generationDone(new Exception("From: void done()"));
        }
//# END TODO
        }
...
//# BEGIN TODO Implementation of abort()
        generatorWorker.setupPredicate(true);
